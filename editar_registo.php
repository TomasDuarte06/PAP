                        ...
                        <section class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row pb-4">
                                    <label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault">Nome</label>
                                    <div class="col-lg-6">
                                        <input type="text" name="nome" value="<?php echo $row['nome']; ?>" class="form-control">
                                    </div>
                                </div>
                                              <div class="form-group row pb-4">
                                    <label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault">Telefone</label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row pb-4">
                                    <label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault">Morada</label>
                                    <div class="col-lg-6">
                                        <input type="text" name="morada" value="<?php echo $row['morada']; ?>" class="form-control">
                                    </div>
                                </div>
                            </div>
