                ...
                ?>
                    <tr>
                        ...
                        <td class="actions text-left">
                            ...
                            <a href="editar_registo.php?id=<?php echo $row['idc']; ?>" class="btn btn-sm btn-sm-custom" title="Editar">
                                <i class="fas fa-pencil-alt" style="color: black;"></i>
                            </a>

                            <!-- Formulário para exclusão com alerta de confirmação -->
                            <form method="post" action="apagarregisto.php" style="display:inline;" onsubmit="return confirm('Tem certeza que deseja apagar este registro?');">
