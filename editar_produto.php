	...
	<section class="body">
		...
		<div class="inner-wrapper">
            ...
            if ($showForm && isset($_GET['id'])) {
								...
								<section class="card">
									<div class="card-body">
										...
										<div class="form-group row pb-4">
											...
											<div class="col-lg-6">
												<input type="text" name="eletrodomestico"
													value="<?php echo $row['eletrodomestico']; ?>" class="form-control">
											</div>
										</div>
										<div class="form-group row pb-4">
											<label class="col-lg-3 control-label text-lg-end pt-2"
										...
										<div class="form-group row pb-4">
											...
											<div class="col-lg-6">
												<input type="text" name="referencia"
													value="<?php echo $row['referencia']; ?>" class="form-control">
											</div>
										</div>
										<div class="form-group row pb-4">
											<label class="col-lg-3 control-label text-lg-end pt-2"
                ...
                while ($estado_row = mysqli_fetch_array($result)) {
                    $selected = ($estado_row['estado'] == $row['estado']) ? 'selected' : '';
