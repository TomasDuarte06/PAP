    ...
    <div class="form-container">
        <div class="w-100">
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
                ...
                $sql = "UPDATE eletrodomesticos SET gama = '$fgama', eletrodomestico = '$feletrodomestico', marca = '$fmarca', modelo = '$fmodelo', referencia = '$freferencia', estado_electro = '$festado', observacoes = '$fobsesrvacoes' WHERE idc = $id";
                        ...
                        <section class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row pb-4">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="nome" value="<?php echo $row['marca']; ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row pb-4">
								...
								<div class="form-group row pb-4">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="estado_electro	" value="<?php echo $row['estado_electro']; ?>" class="form-control">
                                    </div>
                                </div>  
								<div class="form-group row pb-4">
                                    <label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault">Observacoes</label>
                                    <div class="col-lg-6">
                                        <input type="text" name="observacoes	" value="<?php echo $row['observacoes']; ?>" class="form-control">
                                    </div>
                                </div>  
                            </div>
