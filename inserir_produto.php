                ...
                <section class="card">
                    <div class="card-body">
							<div class="form-group row pb-4">
								<label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault">Dono de Eletrodomestico</label>
									<div class="col-lg-6">
							...
							<div class="form-group row pb-4">
                                ...
                                <?php } ?>
										...
										<div class="form-group row pb-3">
												...
												<div class="col-lg-6">
													<textarea name="observacoes" class="form-control" rows="3" id="textareaDefault"></textarea>
