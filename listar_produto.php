					...
					<div id="userbox" class="userbox">
						<a href="#" data-bs-toggle="dropdown">
							<figure class="profile-picture">
								<img src="img/faviicon.png" alt="Joseph Doe" class="rounded-circle" data-lock-picture="img/!logged-user.jpg" />
							</figure>
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled mb-2">
								...
								<li>
									<a role="menuitem" tabindex="-1" href="index.html"><i class="bx bx-power-off"></i> Logout</a>
								</li>
							</ul>
						</div>
					</div>
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper text-end">
							...
							<a class="sidebar-right-toggle" dclass="sidebar-right-wrapper"><i class="fas fa-chevron-left"></i></a>
						</div>
					</header>
<?php
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-striped mb-0" id="datatable-editable">
           ...
           <tbody>
		   <?php
// Consulta a base de dados para obter os registros dos eletrodomésticos
...
while($row = mysqli_fetch_array($result)) { 
    ?>
    <tr>
        <!-- Exibição de dados do eletrodoméstico -->
        <td class="border-b dark:border-dark-5"><?php echo $row['ide'] ?></td>
        <td class="border-b dark:border-dark-5"><?php 
    // Consulta para obter o nome associado ao idc atual
    $idc = $row['idc'];
    $query_nome = "SELECT nome FROM clientes WHERE idc = $idc";
    $result_nome = mysqli_query($link, $query_nome); 
    // Recupera o nome se houver resultado, caso contrário exibe uma mensagem padrão
    $row_nome = mysqli_fetch_assoc($result_nome);
    echo $row_nome ? $row_nome['nome'] : "Nome não encontrado";
?></td>

        <td class="border-b dark:border-dark-5"><?php echo $row['gama'] ?></td>
        <td class="border-b dark:border-dark-5"><?php echo $row['eletrodomestico'] ?></td>
        <td class="border-b dark:border-dark-5"><?php echo $row['marca'] ?></td>
        <td class="border-b dark:border-dark-5"><?php echo $row['modelo'] ?></td>
        <td class="border-b dark:border-dark-5"><?php echo $row['referencia'] ?></td>
        <td class="border-b dark:border-dark-5"><?php echo $row['estado_electro'] ?></td>
        <!-- <td class="border-b dark:border-dark-5"><?php echo $row['observacoes'] ?></td> -->
		<td class="actions text-left">
                            ...
                            <form method="post" action="apagarproduto.php" style="display:inline;" onsubmit="return confirm('Tem certeza que deseja apagar este registro?');">
                                <input type="hidden" name="id" value="<?php echo $row['ide']; ?>">
                                <button type="submit" class="btn btn-sm btn-sm-custom delete-btn" title="Excluir">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <h4><a class="logo">
					...
					</a>Visite-nos</h4>Travessa São Romão Nº7, Barracão, Cantanhede - Coimbra, Portugal            </div>
            <div class="col-lg-4 col-md-6">
                <h4>Siga-nos</h4>
                <ul class="social-icons">
                    <li><a href="https://www.facebook.com/tomas.duarte.7583992/" target="_blank"><i class="fab fa-facebook"></i></a>  Facebook</li>
                    <li><a href="https://www.linkedin.com/in/tomás-duarte-2b0816294" target="_blank"><i class="fab fa-linkedin"></i></a>  Linkedin</li>
                    <li><a href="https://www.instagram.com/_tomas.duarte_/" target="_blank"><i class="fab fa-instagram"></i></a>  Instagram</li>
                </ul>
            </div>
